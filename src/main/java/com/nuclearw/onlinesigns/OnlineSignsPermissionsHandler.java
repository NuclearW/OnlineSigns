...
public class OnlineSignsPermissionsHandler {
	...
	public OnlineSignsPermissionsHandler(OnlineSigns instance) {
		plugin = instance;
	}
	...
	public static void initialize(Server server) {
		...
		if(PEXtest != null) {
			...
			permissionsEnabled = true;
			plugin.log.info("[OnlineSigns] Permissions "+test.getDescription().getVersion()+" found.");
		} else {
			//plugin.log.info("[OnlineSigns] Permissions not found, falling back to ops.");
	...
	public static void onEnable(Plugin pluginEnabled) {
		...
		if(pluginName.equals("PermissionsEx")) {
			...
			permissionType = PermissionType.PERMISSIONS;
			permissionsEnabled = true;
			plugin.log.info("[OnlineSigns] Permissions "+pluginEnabled.getDescription().getVersion()+" found.");
		}
	}
